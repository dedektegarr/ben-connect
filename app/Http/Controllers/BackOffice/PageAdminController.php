...
class PageAdminController extends Controller
{
    ...
    public function kependudukan(Request $request){
       // Load JSON files
        ...
        return view('BackOffice.kependudukan', compact(
            'indeks_angka_kemiskinan','indeks_pembangunan_gender','indeks_pembangunan_manusia','indeks_pemberdayaan_gender', 'selectedKabupaten', 'kab_kota', 'filteredData'
        ));
    }
    ...
    public function infrastruktur(Request $request){
        ...
        return view('BackOffice.infrastruktur', compact('kab_kota','selectedKabupaten','filteredData','jalan','totalJalanNasional','totalJalanProvinsi','totalJalanKabupaten'));
    }
