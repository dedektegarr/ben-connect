        ...
        <x-panel.panel-body class="w-full p-10 bg-gray-900 rounded-lg shadow-lg">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium">Persentase Jalan Rusak Berat</p>
                            {{-- <p class="text-3xl font-bold">20,06%</p> --}}
                            <p class="text-3xl font-bold">{{ number_format($persentase_rusak_berat ?? 0, 2) }}%</p>
                        </div>
                        <div class="p-3 bg-white/10 rounded-full">
                            <svg class="w-8 h-8 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div id="import-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="POST" action="{{ route('admin.infrastruktur.jalan.import') }}"
