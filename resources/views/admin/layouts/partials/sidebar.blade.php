        ...
        <ul class="space-y-2 font-medium pt-5 mt-5 border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
                <button type="button"
                    ...
                    aria-controls="dropdown-pemerintahan" data-collapse-toggle="dropdown-pemerintahan">

                    <div class="flex items-center">
                        <svg class="sidebar-menu-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
                <button type="button"
                    ...
                    <svg class="{{ Route::is('admin.infrastruktur.*') ? 'active' : '' }} sidebar-menu-icon"aria-hidden="true"
                ...
                <ul id="dropdown-infrastruktur"
                    ...
                    <li>
                        <a href="{{ route('admin.infrastruktur.jalan.index') }}"
                            class="{{ Route::is('admin.infrastruktur.jalan.*') ? 'active' : '' }} sidebar-sub-menu">{{ __('Data Jalan') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.infrastruktur.irigasi.index') }}"
                            class="{{ Route::is('admin.infrastruktur.irigasi.*') ? 'active' : '' }} sidebar-sub-menu">{{ __('Data Irigasi') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.infrastruktur.jembatan.index') }}"
                            class="{{ Route::is('admin.infrastruktur.jembatan.*') ? 'active' : '' }} sidebar-sub-menu">{{ __('Data Jembatan') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.infrastruktur.ciptakarya.index') }}"
                            class="{{ Route::is('admin.infrastruktur.ciptakarya.*') ? 'active' : '' }} sidebar-sub-menu">{{ __('Data Cipta Karya') }}</a>
                    </li>
                </ul>
            </li>
            <li>
                <button type="button"
                    class="{{ Route::is('admin.sosial.*') ? 'active' : '' }} sidebar-menu-link group w-full"
                    aria-controls="dropdown-sosial" data-collapse-toggle="dropdown-sosial">
                    {{-- <svg class="{{ Route::is('admin.sosial.*') ? 'active' : '' }} sidebar-menu-icon"aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M4 4a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2v14a1 1 0 1 1 0 2H5a1 1 0 1 1 0-2V5a1 1 0 0 1-1-1Zm5 2a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H9Zm5 0a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-1Zm-5 4a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1H9Zm5 0a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1h-1Zm-3 4a2 2 0 0 0-2 2v3h2v-3h2v3h2v-3a2 2 0 0 0-2-2h-2Z" clip-rule="evenodd"/>
                      </svg> --}}
                    <svg class="{{ Route::is('admin.sosial.*') ? 'active' : '' }} sidebar-menu-icon"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                            d="M12 6a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm-1.5 8a4 4 0 0 0-4 4 2 2 0 0 0 2 2h7a2 2 0 0 0 2-2 4 4 0 0 0-4-4h-3Zm6.82-3.096a5.51 5.51 0 0 0-2.797-6.293 3.5 3.5 0 1 1 2.796 6.292ZM19.5 18h.5a2 2 0 0 0 2-2 4 4 0 0 0-4-4h-1.1a5.503 5.503 0 0 1-.471.762A5.998 5.998 0 0 1 19.5 18ZM4 7.5a3.5 3.5 0 0 1 5.477-2.889 5.5 5.5 0 0 0-2.796 6.293A3.501 3.501 0 0 1 4 7.5ZM7.1 12H6a4 4 0 0 0-4 4 2 2 0 0 0 2 2h.5a5.998 5.998 0 0 1 3.071-5.238A5.505 5.505 0 0 1 7.1 12Z"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">{{ __('Sosial') }}</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
                ...
                <ul id="dropdown-sosial"
                    class="{{ Route::is('admin.sosial.*') ? 'block' : 'hidden' }} py-2 space-y-2 ml-10">
                    <li>
                        <a href="{{ route('admin.sosial.databansos.index') }}"
                            class="{{ Route::is('admin.sosial.databansos.*') ? 'active' : '' }} sidebar-sub-menu">{{ __('Bantuan Sosial') }}</a>
                    </li>
                </ul>
            </li>
            <li>
                <button type="button"
                    class="{{ Route::is('admin.ketenagakerjaan.*') ? 'active' : '' }} sidebar-menu-link group w-full"
                    aria-controls="dropdown-ketenagakerjaan" data-collapse-toggle="dropdown-ketenagakerjaan">
                    {{-- <svg class="{{ Route::is('admin.ketenagakerjaan.*') ? 'active' : '' }} sidebar-menu-icon" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                            d="M4 4a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2v14a1 1 0 1 1 0 2H5a1 1 0 1 1 0-2V5a1 1 0 0 1-1-1Zm5 2a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H9Zm5 0a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-1Zm-5 4a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1H9Zm5 0a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1h-1Zm-3 4a2 2 0 0 0-2 2v3h2v-3h2v3h2v-3a2 2 0 0 0-2-2h-2Z"
                            clip-rule="evenodd" />
                    </svg> --}}
                    <svg class="{{ Route::is('admin.ketenagakerjaan.*') ? 'active' : '' }} sidebar-menu-icon"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span
                        class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">{{ __('Ketenagakerjaan') }}</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
                ...
                <ul id="dropdown-ketenagakerjaan"
                    ...
                    <li>
                        <a href="{{ route('admin.ketenagakerjaan.umr.index') }}"
                            class="{{ Route::is('admin.ketenagakerjaan.umr.index') ? 'active' : '' }} sidebar-sub-menu">
                            {{ __('Upah Minimum Regional') }}
                        </a>
                    </li>
                </ul>
            </li>
