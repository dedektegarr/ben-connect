        ...
        <x-panel.panel-body>
            <div
                ...
                <table id="default-table" class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            <th class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">Kode
                                BPS 2023</th>
                            <th class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Kabupaten Kota</th>
                            <th class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">Nama
                                Variant</th>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const data = [{
                    ...
                    variant: "Bawang Bombai",
                    prices: [38000, 38000, 38000, 38000]
                },
                {
                    kode: "1701",
                    kota: "Kab. Bengkulu Selatan",
                    variant: "Bawang Merah",
                    prices: [40000, 35000, 35000, 35000]
                },
                {
                    kode: "1701",
                    kota: "Kab. Bengkulu Selatan",
                    variant: "Bawang Putih Honan",
                    prices: [42000, 40000, 40000, 40000]
                }
            ];
