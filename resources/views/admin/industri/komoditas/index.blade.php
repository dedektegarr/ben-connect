            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium">Total Komoditas</p>
                            <p class="text-3xl font-bold">{{ number_format($total_komoditas ?? 0) }}</p>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium">Harga Rata-Rata Komoditas</p>
                            <p class="text-3xl font-bold">{{ number_format($harga_rata_rata ?? 0) }}</p>
                        </div>
                        <div class="p-3 bg-white/10 rounded-full">
                            <svg class="w-8 h-8 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
          ...
          <div
              ...
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                  {{ __('Impor Data Komoditas') }}
              </h3>
          </div>
          <!-- Modal body -->
          <form class="p-4 md:p-5" method="POST" action="{{ route('admin.perindustrian.komoditas.import') }}" enctype="multipart/form-data">
