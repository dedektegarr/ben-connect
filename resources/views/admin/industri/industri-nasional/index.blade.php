            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium">Industri Kecil</p>
                            <p class="text-3xl font-bold">{{ number_format($total_kecil) }}</p>
                        </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium">Industri Besar</p>
                            <p class="text-3xl font-bold">{{ number_format($total_besar) }}</p>
                        </div>
                        <div class="p-3 bg-white/10 rounded-full">
                            <svg class="w-8 h-8 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold">{{ number_format($total_kecil + $total_besar) }}</p>
                        </div>
                        <div class="p-3 bg-white/10 rounded-full">
                            <svg class="w-8 h-8 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <form method="GET" action="">
                <div class="flex items-center gap-4 justify-between mb-6">
                    <div class="flex gap-4 items-center w-full">
                        ...
                        <div class="w-full">
                            <label for="skala" class="sr-only">Skala Usaha</label>
