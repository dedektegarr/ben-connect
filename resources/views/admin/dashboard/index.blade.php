...
@section('content') --}}
    {{-- <x-panel.panel class="w-full">
        ...
        <x-panel.panel-body class="w-full p-6">

            <div class="flex flex-col md:flex-row items-start bg-white border border-gray-200 rounded-lg shadow-sm w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <img class="object-cover w-full md:w-1/3 rounded-t-lg md:rounded-none md:rounded-l-lg" src="{{ asset('assets/FrontOffice/img/gubernur1.png') }}" alt="">
                <div class="flex flex-col justify-between p-6 leading-normal w-full md:w-2/3">
                    <h5 class="mb-4 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">VISI</h5>
                    <p class="mb-6 text-lg text-gray-700 dark:text-gray-400">Bengkulu Maju, Religius, Sejahtera, dan Berkelanjutan.</p>

                    <h5 class="mb-4 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">MISI</h5>
                    <ul class="list-disc pl-6 text-gray-700 dark:text-gray-400 space-y-2 text-lg">
                        <li>Fokus pada membangun Bengkulu yang berbasis religiusitas, kesejahteraan sosial, dan keberlanjutan ekonomi.</li>
                        <li>Mengutamakan pemerintahan yang bersih dan akuntabel dengan pembangunan sumber daya manusia yang berlandaskan pengetahuan dan teknologi.</li>
                        <li>Program percepatan peningkatan kualitas jalan dan jembatan di seluruh Provinsi Bengkulu melalui program Jalan Mulus.</li>
